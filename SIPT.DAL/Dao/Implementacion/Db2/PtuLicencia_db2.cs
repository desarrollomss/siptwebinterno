...
namespace SIPT.DAL.Dao.Implementacion.Db2
{
	public class PtuLicencia_db2: PtuLicencia_dao
	{
								...
								int? intcodsolicitud)
		{
			...
			return DB2Comando.Listar<PtuLicencia>((DB2Transaction)this.dbconex.Transaccion(), CommandType.StoredProcedure, "SIPT.PTULICENCIA_LISTARKEYS", this.logMensajes, arrParam);			
		}
