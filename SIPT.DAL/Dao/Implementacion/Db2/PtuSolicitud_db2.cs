    ...
    public class PtuSolicitud_db2: PtuSolicitud_dao
    {
        ...
        public override int Insertar(PtuSolicitud pPtuSolicitud)
        {
            ...
            try
            {
                ...
                DB2helper.ExecuteNonQuery((DB2Transaction)this.dbconex.Transaccion(), CommandType.StoredProcedure, "SIPT.PTUSOLICITUD_INSERTAR", arrParam);
            ...
            {
                Log.Debug(this.logMensajes.codigoMensaje.ToString(), "SIPT.PTUSOLICITUD_INSERTAR");
        ...
        public override PtuSolicitud Actualizar(PtuSolicitud pPtuSolicitud)
        {
            ...
            try
            {
                ...
                DB2helper.ExecuteNonQuery((DB2Transaction)this.dbconex.Transaccion(), CommandType.StoredProcedure, "SIPT.PTUSOLICITUD_ACTUALIZAR", arrParam);
            }
            catch (Exception ex)
            {
                Log.Error(this.logMensajes.codigoMensaje.ToString(), ex.Message);                
            ...
            {
                Log.Info(this.logMensajes.codigoMensaje.ToString(), "SIPT.PTUSOLICITUD_ACTUALIZAR");
                Log.Debug(this.logMensajes.codigoMensaje.ToString(), arrParam);
            }
        ...
        public override void Eliminar(PtuSolicitud pPtuSolicitud)
        {
            ...
            try
            {
                ...
                DB2helper.ExecuteNonQuery((DB2Transaction)this.dbconex.Transaccion(), CommandType.StoredProcedure, "SIPT.PTUSOLICITUD_ELIMINAR", arrParam);
            }
            catch (Exception ex)
            {
                Log.Error(this.logMensajes.codigoMensaje.ToString(), ex.Message);                
            ...
            {
                Log.Info(this.logMensajes.codigoMensaje.ToString(), "SIPT.PTUSOLICITUD_ELIMINAR");
                Log.Debug(this.logMensajes.codigoMensaje.ToString(), arrParam);
            }
        }
        ...
        public override List<PtuSolicitud> Listar()
        {
            try
            {
                ...
                dataReader = DB2helper.ExecuteReader((DB2Transaction)this.dbconex.Transaccion(), CommandType.StoredProcedure, "SIPT.PTUSOLICITUD_LISTAR");
                                
                oPtuSolicitudList = ConvertidorUtil.DeReaderAColeccion<PtuSolicitud, List<PtuSolicitud>>(dataReader);
            }
            catch (Exception ex)
            {
                Log.Error(this.logMensajes.codigoMensaje.ToString(), ex.Message);                
            ...
            {
                Log.Info(this.logMensajes.codigoMensaje.ToString(), "SIPT.PTUSOLICITUD_LISTAR");
                Log.Debug(this.logMensajes.codigoMensaje.ToString(), oPtuSolicitudList);
            }
            return oPtuSolicitudList;
        }
        ...
        public override PtuSolicitud ListarPorId(int? intcodsolicitud)
        {
            ...
            try
            {
                ...
                DB2DataReader dataReader;
                dataReader = DB2helper.ExecuteReader((DB2Transaction)this.dbconex.Transaccion(), CommandType.StoredProcedure, "SIPT.PTUSOLICITUD_LISTARKEY", arrParam);

                oPtuSolicitud = ConvertidorUtil.DeReaderAEntidad<PtuSolicitud>(dataReader);                
            }
            catch (Exception ex)
            {
                Log.Error(this.logMensajes.codigoMensaje.ToString(), ex.Message);                
            ...
            {
                Log.Info(this.logMensajes.codigoMensaje.ToString(), "SIPT.PTUSOLICITUD_LISTARKEY");
                Log.Debug(this.logMensajes.codigoMensaje.ToString(), arrParam);
                Log.Debug(this.logMensajes.codigoMensaje.ToString(), oPtuSolicitud);
            }
            return oPtuSolicitud;
        }
        ...
        public override List<PtuSolicitud_PorAnalistaPorSolicitante> ListarPorAnalistaPorSolicitante(int? intcodigosolicitante, int? intusuanalista)
        {
            ...
            try
            {
                ...
                dataReader = DB2helper.ExecuteReader((DB2Transaction)this.dbconex.Transaccion(), CommandType.StoredProcedure, "SIPT.PTUSOLICITUD_LISTARPORANALISTAPORSOLICITANTE", arrParam);
            ...
            {
                Log.Info(this.logMensajes.codigoMensaje.ToString(), "SIPT.PTUSOLICITUD_LISTARPORANALISTAPORSOLICITANTE");
                Log.Debug(this.logMensajes.codigoMensaje.ToString(), arrParam);
                Log.Debug(this.logMensajes.codigoMensaje.ToString(), oPtuSolicitud_PorAnalistaPorSolicitante);
            }
        ...
        public override List<PtuSolicitud_PorAnalistaPorSolicitante> ListarPendientes(PtuSolicitud pPtuSolicitud, int? intusuanalista)
        {
            try
            {
                ...
                dataReader = DB2helper.ExecuteReader((DB2Transaction)this.dbconex.Transaccion(), CommandType.StoredProcedure, "SIPT.PTUSOLICITUD_LISTAR_PENDIENTES", arrParam);
                oPtuSolicitud_PorAnalistaPorSolicitante = ConvertidorUtil.DeReaderAColeccion<PtuSolicitud_PorAnalistaPorSolicitante, List<PtuSolicitud_PorAnalistaPorSolicitante>>(dataReader);
            }
            catch (Exception ex)
            {
            ...
            {
                Log.Info(this.logMensajes.codigoMensaje.ToString(), "SIPT.PTUSOLICITUD_LISTAR_PENDIENTES");
                Log.Debug(this.logMensajes.codigoMensaje.ToString(), oPtuSolicitudList);
            }
            return oPtuSolicitud_PorAnalistaPorSolicitante;
        }
        ...
        public override List<PtuSolicitud_PorAnalistaPorSolicitante> ListarAcreditar(PtuSolicitud pPtuSolicitud, int? intusuanalista)
        {
            try
            {
                ...
                dataReader = DB2helper.ExecuteReader((DB2Transaction)this.dbconex.Transaccion(), CommandType.StoredProcedure, "SIPT.PTUSOLICITUD_LISTAR_ACREDITAR", arrParam);
                oPtuSolicitud_PorAnalistaPorSolicitante = ConvertidorUtil.DeReaderAColeccion<PtuSolicitud_PorAnalistaPorSolicitante, List<PtuSolicitud_PorAnalistaPorSolicitante>>(dataReader);
            }
            catch (Exception ex)
            {
            ...
            {
                Log.Info(this.logMensajes.codigoMensaje.ToString(), "SIPT.PTUSOLICITUD_LISTAR_ACREDITAR");
                Log.Debug(this.logMensajes.codigoMensaje.ToString(), oPtuSolicitudList);
            }
            return oPtuSolicitud_PorAnalistaPorSolicitante;
        }
