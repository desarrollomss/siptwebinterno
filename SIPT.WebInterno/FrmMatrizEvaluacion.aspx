                    ...
                    <div class="card-body">
                        ...
                        <div class="row">                                                    
                            ...
                            <div class="col-md-4">
                                ...
                                <asp:Literal ID="ltlClave" runat="server"></asp:Literal> 
                            </div>
                        ...
                        <div class="row">                                                    
                            ...
                            <div class="col-md-6">
                                <asp:Panel ID="pnlClave" runat="server" Visible="true">
                                    <asp:TextBox ID="txtClaves" runat="server" class="form-control" TextMode="MultiLine"></asp:TextBox>
                                </asp:Panel>
                            </div>
                            <div class="col-md-3"></div>
                        </div>
